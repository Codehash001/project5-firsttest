...
function Nfts () {
    ...
    <div className='flex flex-col my-10 mx-16 justify-between '>
       ...
       <div className='mt-10'>
        ...
        <p className='text-center font-Kanit text-[20px] text-gray-400 mt-4 mb-5'>
...
in-game things, yet they cannot sell them. This represents a return on investment.
            ...
            <h1 className='text-3xl text-blue-400  font-Kanit text-center uppercase mt-10 font-semibold tracking-wide'>Our Solution</h1>
        <p className='text-center font-Kanit text-[20px] text-gray-400 mt-4 mb-5'>
...
<div className='mt-10'>
        <h1 className='text-3xl text-blue-400 font-Kanit text-center uppercase font-semibold tracking-wide'>NFT Characters</h1>
        <p className='text-center font-Kanit text-[20px] text-gray-400 mt-4'>
...
guilds systems.
            ...
            <h1 className='text-3xl text-blue-400 font-Kanit text-center uppercase mt-10 font-semibold tracking-wide'>NFT marketplace</h1>
        <p className='text-center font-Kanit text-[20px] text-gray-400 mt-4'>
...
too. Dex coin features blockchain-based digital assets know as "NFTs" that operate on an eco-friendly proof-of-stake blockchain. Because blockchain
...
buy with crypto payment from the game.
       ...
       <div className='mt-10 flex flex-row items-center'>
        ...
        <div className='p-4 flex flex-col w-full h-full font-Kanit justify-between'>
             ...
             <button className='mt-8 text-[20px] py-4 px-10 bg-transparent border border-blue-400 text-blue-400 uppercase'>Buy Dex coin tokens</button>
             <button className='mt-4 text-[20px] py-4 px-10 bg-blue-400 text-black  uppercase'>Go to minting portal</button>
        </div>
